                            ...
                            <div class="col-12">
                                <div class="card login-page border-0" style="z-index: 1">
                                    <div class="card-body p-0">
                                        ...
                                        <form class="login-form mt-4 p-3">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="form-icon position-relative">
                                                            ...
                                                            <input type="password" class="form-control ps-5" placeholder="Ingresa tu contraseña" required="">
                                                        </div>
                                                    </div>
                                                </div><!--end col-->
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <p class="forgot-pass mb-0"><a href="<?=base_url('recover')?>" class="text-dark fw-bold">¿Olvidaste tu contraseña?</a></p>
                                                    </div>
                                                </div><!--end col-->

                                                <div class="col-lg-12 mb-0">
                                                    <div class="d-grid">
                                                        <button class="btn btn-primary" onclick="window.location.href='<?=base_url('home')?>'">Ingresar</button>
                                                    </div>
                                                </div><!--end col-->
