                ...
                <form class="row g-3 needs-validation" id='modal-form-restaurantes' novalidate>
                    ...
                    <div class="form-group col-12 m-2">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <select class="form-control" required name="zona" id='zona' value="">
                                <option selected disabled value="">¿En que zona se encuentra?</option>
                                <option value="1">Zona A</option>
                                <option value="2">Zona B</option>
                            </select>
                            <div class="zona invalid-feedback">
                            </div>
                        </div>
                    </div>
