...
(function (h) {
	...
	m.ext = x = {
		...
		classes: {},
		build:
			"bs4/dt-1.10.16/af-2.2.2/b-1.5.1/cr-1.4.1/fc-3.2.4/fh-3.1.3/kt-2.3.2/r-2.2.1/rg-1.0.2/rr-1.2.3/sc-1.4.4/sl-1.2.5",
		errMode: "alert",
		feature: [],
		search: [],
		...
		_draw: function () {
			...
			for (var g = 0, f = c.length; g < f; g++) {
				...
				this.c.startRender &&
					...
					this._rowWrap(d, this.c.startClassName).insertBefore(l.node()));
				this.c.endRender &&
			...
			if (!this.s.skip && !this.s.ingnoreScroll)
				if (this.s.dt.bFiltered || this.s.dt.bSorted) this.s.lastScrollTop = 0;
					...
					if (
						...
						this.s.forceReposition
							? ((d =
									parseInt(this._domain("physicalToVirtual", c) / b.row, 10) -
									f),
							  (this.s.topRowFloat =
